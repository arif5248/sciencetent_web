...
function PopupForModifyExam({ content, onClose }) {
  ...
  const [examName, setExamName] = useState(content.examDetails.name || "");
  const [examCode, setExamCode] = useState(content.examDetails.examCode || "");
  let [selectedCourses, setSelectedCourses] = useState(content.examDetails.courses || []);
  const [selectedBatches, setSelectedBatches] = useState(content.examDetails.batches ||[]);
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        updatedCourses[index] = {
                          ...updatedCourses[index],
                          marks: {
                            ...updatedCourses[index].marks, // Copy marks object
                            cq: e.target.value, // Update cq
                          },
                        };
                        setSelectedCourses(updatedCourses);
                      }}
...
export default PopupForModifyExam;
